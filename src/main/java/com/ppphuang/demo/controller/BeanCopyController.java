...
public class BeanCopyController {
    ...
    public ComplicatedOrderDO wrong() {
        ...
        //属性错误
        orderDO.setCommentable(orderDTO.isComplainable());
        //属性错误
        orderDO.setComplainable(orderDTO.isCommentable());
        orderDO.setCancelable(orderDTO.isCancelable());
        ...
        //对象错误
        orderDO.setDeliveryManMobile(orderDO.getDeliveryManMobile());
        ...
        //属性赋值错误
        orderDO.setLatitude(orderDTO.getLongitude());

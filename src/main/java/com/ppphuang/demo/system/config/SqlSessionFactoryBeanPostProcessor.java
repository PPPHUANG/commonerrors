...
public class SqlSessionFactoryBeanPostProcessor implements BeanPostProcessor {
    ...
    private final EmojiTransferInterceptior emojiTransferInterceptior;

    public SqlSessionFactoryBeanPostProcessor(PageHelper pageHelper, MybatisLimitInterceptor mybatisLimitInterceptor, EmojiTransferInterceptior emojiTransferInterceptior) {
        this.pageHelper = pageHelper;
        this.mybatisLimitInterceptor = mybatisLimitInterceptor;
        this.emojiTransferInterceptior = emojiTransferInterceptior;
    }
    ...
    public Object postProcessBeforeInitialization(Object bean, String beanName) throws BeansException {
        ...
        if (bean instanceof SqlSessionFactoryBean) {
            ...
            nowBean.setPlugins(new Interceptor[]{emojiTransferInterceptior, mybatisLimitInterceptor, pageHelper});
        }
